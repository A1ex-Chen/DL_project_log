def parse_opt(known=False):
    ...
    parser.add_argument('--project', default=ROOT / 'runs/train-seg', help=
    ...
    parser.add_argument('--mask-ratio', type=int, default=4, help=
        'Downsample the truth masks to saving memory')
    parser.add_argument('--no-overlap', action='store_true', help=
        'Overlap masks train faster at slightly less mAP')
