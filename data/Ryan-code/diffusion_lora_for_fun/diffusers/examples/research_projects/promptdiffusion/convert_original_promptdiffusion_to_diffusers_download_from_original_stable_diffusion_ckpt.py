def download_from_original_stable_diffusion_ckpt(checkpoint_path_or_dict:
    ...
    pipeline_class: DiffusionPipeline=None, local_files_only=False,
    vae_path=None, vae=None, text_encoder=None, text_encoder_2=None,
    tokenizer=None, tokenizer_2=None, config_files=None) ->DiffusionPipeline:
    """
