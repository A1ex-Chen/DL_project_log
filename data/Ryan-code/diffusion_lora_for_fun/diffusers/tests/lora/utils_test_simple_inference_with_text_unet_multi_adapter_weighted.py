def test_simple_inference_with_text_unet_multi_adapter_weighted(self):
    ...
    for scheduler_cls in [DDIMScheduler, LCMScheduler]:
        ...
        output_adapter_mixed_weighted = pipe(**inputs, generator=torch.
            manual_seed(0)).images
        self.assertFalse(np.allclose(output_adapter_mixed_weighted,
            output_adapter_mixed, atol=0.001, rtol=0.001),
