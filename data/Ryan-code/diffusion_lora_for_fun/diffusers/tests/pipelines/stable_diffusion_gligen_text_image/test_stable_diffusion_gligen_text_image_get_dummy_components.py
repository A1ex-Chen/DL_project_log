def get_dummy_components(self):
    ...
    unet = UNet2DConditionModel(block_out_channels=(32, 64),
        ...
        cross_attention_dim=32, attention_type='gated-text-image')
    ...
    image_encoder_config = CLIPVisionConfig(hidden_size=32, projection_dim=
        32, intermediate_size=37, layer_norm_eps=1e-05, num_attention_heads
        =4, num_hidden_layers=5)
    ...
    components = {'unet': unet, 'scheduler': scheduler, 'vae': vae,
        ...
        image_encoder, 'image_project': image_project, 'processor': processor}
    return components
