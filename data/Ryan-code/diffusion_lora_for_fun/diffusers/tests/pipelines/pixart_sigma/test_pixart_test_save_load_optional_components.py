def test_save_load_optional_components(self):
    ...
    (prompt_embeds, prompt_attention_mask, negative_prompt_embeds,
        negative_prompt_attention_mask) = pipe.encode_prompt(prompt)
    inputs = {'prompt_embeds': prompt_embeds, 'prompt_attention_mask':
        prompt_attention_mask, 'negative_prompt': None,
        'negative_prompt_embeds': negative_prompt_embeds,
        'negative_prompt_attention_mask': negative_prompt_attention_mask,
        'generator': generator, 'num_inference_steps': num_inference_steps,
        'output_type': output_type, 'use_resolution_binning': False}
