...
def __call__(self, prompt: Union[str, List[str]], negative_prompt: Optional
    ...
    bool=True, callback_on_step_end: Optional[Callable[[int, int, Dict],
    ...
    prompt_embeds, text_encoder_hidden_states, text_mask = self._encode_prompt(
        prompt, device, num_images_per_prompt, self.
    ...
    for i, t in enumerate(self.progress_bar(timesteps)):
        ...
        if self.do_classifier_free_guidance:
            ...
            predicted_image_embedding = (predicted_image_embedding_uncond +
                self.guidance_scale * (predicted_image_embedding_text -
