                ...
                for inject_inf in inject_inf_iters:
                    ...
                    for inject_inf_loc in inject_inf_locs:
                        for which_backward in which_backwards:
                            ...
                            optimizer0 = torch.optim.SGD([{'params': model0
                                .parameters(), 'lr': 0.25}], momentum=0.125)
                            optimizer1 = torch.optim.SGD([{'params': model1
                                .parameters(), 'lr': 0.5}], momentum=0.25)
                            ...
                            master_params = [p for p in amp.master_params(
                                optimizer0)] + [p for p in amp.
                                master_params(optimizer1)]
                            for model, master, reference in zip(model_params,
                                master_params, final_params[
