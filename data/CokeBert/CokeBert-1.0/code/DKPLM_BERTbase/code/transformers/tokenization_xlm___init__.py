def __init__(self, vocab_file, merges_file, unk_token='<unk>', bos_token=
    ...
    super(XLMTokenizer, self).__init__(unk_token=unk_token, bos_token=
        bos_token, sep_token=sep_token, pad_token=pad_token, cls_token=
        cls_token, mask_token=mask_token, additional_special_tokens=
