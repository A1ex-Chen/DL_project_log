...
def from_single_file(cls, pretrained_model_link_or_path, **kwargs):
    ...
    component = create_diffusers_vae_model_from_ldm(class_name,
        original_config, checkpoint, image_size=image_size, scaling_factor=
        scaling_factor, torch_dtype=torch_dtype)
    vae = component['vae']
