def step(self, model_output: torch.Tensor, timestep: int, sample: torch.
    ...
    lower_order_final = self.step_index == len(self.timesteps
    ...
    if (self.config.solver_order == 1 or self.lower_order_nums < 1 or
        ...
        prev_sample = self.multistep_deis_second_order_update(self.
            model_outputs, sample=sample)
    else:
        prev_sample = self.multistep_deis_third_order_update(self.
            model_outputs, sample=sample)
