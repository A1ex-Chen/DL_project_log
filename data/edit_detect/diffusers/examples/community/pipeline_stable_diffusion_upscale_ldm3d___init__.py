def __init__(self, vae: AutoencoderKL, text_encoder: CLIPTextModel,
    ...
    requires_safety_checker: bool=True, watermarker: Optional[Any]=None,
    ...
    self.image_processor = VaeImageProcessorLDM3D(vae_scale_factor=self.
        vae_scale_factor, resample='bilinear')
