...
def __init__(self, in_channels: int=3, out_channels: int=3,
    ...
    layers_per_block: int=1, act_fn: str='silu', latent_channels: int=3,
    sample_size: int=32, num_vq_embeddings: int=256, norm_num_groups: int=
    32, vq_embed_dim: Optional[int]=None, scaling_factor: float=0.18215):
    super().__init__()
    ...
    self.decoder = Decoder(in_channels=latent_channels, out_channels=
        ...
        act_fn, norm_num_groups=norm_num_groups)
