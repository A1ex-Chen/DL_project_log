def add_custom_config(cfg):
    ...
    cfg.MODEL.CUSTOM.SOFT_NMS_METHOD = 'linear'
    ...
    cfg.VISDRONE = CN()
    cfg.VISDRONE.TRAIN_JSON = (
        'data/visdrone/coco_format/annotations/train_label.json')
    cfg.VISDRONE.TRING_IMG_ROOT = 'data//visdrone/coco_format/train_images'
    cfg.VISDRONE.TEST_JSON = (
        'data/visdrone/coco_format/annotations/val_label.json')
