...
def get_food101(data_root=None, img_size=224, batch_size=64,
    ...
    dataset_train = Food101(root=data_root, split='train', download=
        download, transform=train_transforms or default_train_transforms)
    dataset_eval = Food101(root=data_root, split='test', download=download,
