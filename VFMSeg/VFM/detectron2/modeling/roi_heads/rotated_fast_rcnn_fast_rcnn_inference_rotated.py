def fast_rcnn_inference_rotated(boxes, scores, image_shapes, score_thresh,
    ...
    result_per_image = [fast_rcnn_inference_single_image_rotated(
        ...
        nms_thresh, topk_per_image) for scores_per_image, boxes_per_image,
        image_shape in zip(scores, boxes, image_shapes)]
