def __init__(self, args, split, preprocess_dir, nuscenes_dir='',
    pselab_paths=None, vfm_data_paths='', merge_classes=False, scale=20,
    full_scale=4096, resize=(400, 225), image_normalizer=None, noisy_rot=
    0.0, flip_x=0.0, rot_z=0.0, transl=False, fliplr=0.0, color_jitter=None,
    output_orig=False):
