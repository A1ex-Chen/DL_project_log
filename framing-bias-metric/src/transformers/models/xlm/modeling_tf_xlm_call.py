...
@add_code_sample_docstrings(tokenizer_class=_TOKENIZER_FOR_DOC, checkpoint=
    'xlm-mlm-en-2048', output_type=TFQuestionAnsweringModelOutput,
...
def call(self, input_ids=None, attention_mask=None, langs=None,
    ...
    output_hidden_states=None, return_dict=None, start_positions=None,
    ...
    inputs = input_processing(func=self.call, input_ids=input_ids,
        ...
        output_hidden_states, return_dict=return_dict, start_positions=
        start_positions, end_positions=end_positions, training=training,
        kwargs_call=kwargs)
