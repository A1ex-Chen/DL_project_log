...
def __call__(self, prompt: Optional[Union[str, List[str]]]=None,
    ...
    None, prior_latents: Optional[torch.FloatTensor]=None, decoder_latents:
    Optional[torch.FloatTensor]=None, super_res_latents: Optional[torch.
    FloatTensor]=None, text_model_output: Optional[Union[
    CLIPTextModelOutput, Tuple]]=None, text_attention_mask: Optional[torch.
    Tensor]=None, prior_guidance_scale: float=4.0, decoder_guidance_scale:
    ...
    decoder_latents = self.prepare_latents((batch_size,
        ...
        dtype, device, generator, decoder_latents, self.decoder_scheduler)
