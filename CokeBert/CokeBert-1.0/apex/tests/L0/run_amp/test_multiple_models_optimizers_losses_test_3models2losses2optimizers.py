                    ...
                    for inject_inf_loc in inject_inf_locs:
                        for which_backward in which_backwards:
                            ...
                            for which_model in which_models:
                                ...
                                optimizer0 = torch.optim.SGD([{'params':
                                ...
                                [model0, model1, model2], [optimizer0,
                                    optimizer1] = amp.initialize([model0,
                                    model1, model2], [optimizer0,
                                    optimizer1], opt_level=opt_level,
                                    verbosity=0, cast_model_type=False,
                                ...
                                model_params = [p for p in model0.parameters()
                                    ] + [p for p in model1.parameters()] + [p
