def main():
    ...
    client_testset = torch.utils.data.Subset(trainset, list(range(split,
        len(trainset))))
    ...
    try:
        ...
        if torch.cuda.is_available():
            ...
            my_device = 'cpu'
    fl.client.start_numpy_client(server_address='10.1.2.102:8080', client=
        Fl_Client(cid=random.randint(1, 10), model=model, trainloader=
        trainloader, testloader=testloader, sample_rate=sample_rate, device
        =my_device))
