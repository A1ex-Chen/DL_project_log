...
from model.vocab import END_CHAR, START_CHAR
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--logdir", help="place to store things.", type=str, required=True
    )
    parser.add_argument(
        "-o", required=True, help="place to store output smiles", type=str
    )
    ...
    parser.add_argument(
        "-t", help="temperature", default=1.0, required=False, type=float
    )
