def request_queue(self, request_func, retry=3, timeout=30, thread=True,
    verbose=True, progress_total=None, stream_response=None, *args, **kwargs):
    ...
    def retry_request():
        ...
        for i in range(retry + 1):
            ...
            if (HTTPStatus.OK <= response.status_code < HTTPStatus.
                MULTIPLE_CHOICES):
