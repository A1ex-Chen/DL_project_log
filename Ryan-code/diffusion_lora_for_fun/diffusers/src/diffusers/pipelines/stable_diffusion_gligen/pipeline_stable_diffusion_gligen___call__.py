...
def __call__(self, prompt: Union[str, List[str]]=None, height: Optional[int
    ...
    gligen_phrases: List[str]=None, gligen_boxes: List[List[float]]=None,
    ...
    self.check_inputs(prompt, height, width, callback_steps, gligen_phrases,
        gligen_boxes, negative_prompt, prompt_embeds, negative_prompt_embeds)
    ...
    tokenizer_inputs = self.tokenizer(gligen_phrases, padding=True,
    ...
    cross_attention_kwargs['gligen'] = {'boxes': boxes,
