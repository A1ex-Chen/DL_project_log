def encode_prompt(self, prompt, device, num_videos_per_prompt,
    negative_prompt=None, prompt_embeds: Optional[torch.Tensor]=None,
    negative_prompt_embeds: Optional[torch.Tensor]=None, clip_skip:
    Optional[int]=None):
    """
    ...
    if self.do_classifier_free_guidance and negative_prompt_embeds is None:
        ...
        if clip_skip is None:
            ...
            negative_prompt_embeds = negative_prompt_embeds[-1][-(clip_skip +
                1)]
            negative_prompt_embeds = (self.text_encoder.text_model.
                final_layer_norm(negative_prompt_embeds))
