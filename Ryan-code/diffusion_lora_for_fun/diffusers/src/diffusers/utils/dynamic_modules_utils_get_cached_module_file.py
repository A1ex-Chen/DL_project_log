...
def get_cached_module_file(pretrained_model_name_or_path: Union[str, os.
    ...
    ]]=None, force_download: bool=False, resume_download: Optional[bool]=
    None, proxies: Optional[Dict[str, str]]=None, token: Optional[Union[
    ...
    if os.path.isfile(module_file_or_url):
        ...
        if revision is None:
            revision = latest_version if latest_version[1:
                ] in available_versions else 'main'
        ...
        for module_needed in modules_needed:
            ...
            if not (submodule_path / module_needed).exists():
                get_cached_module_file(pretrained_model_name_or_path,
                    ...
                    resume_download, proxies=proxies, token=token, revision
                    =revision, local_files_only=local_files_only)
