def parse_args(input_args=None):
    ...
    parser.add_argument('--offset_noise', action='store_true', default=
        False, help=
    ...
    parser.add_argument('--pre_compute_text_embeddings', action=
        'store_true', help=
    ...
    parser.add_argument('--text_encoder_use_attention_mask', action=
        'store_true', required=False, help=
        'Whether to use attention mask for the text encoder')
    parser.add_argument('--skip_save_text_encoder', action='store_true',
        required=False, help='Set to not save text encoder')
    parser.add_argument('--validation_images', required=False, default=None,
        nargs='+', help=
    ...
    parser.add_argument('--class_labels_conditioning', required=False,
        default=None, help=
    ...
    parser.add_argument('--validation_scheduler', type=str, default=
        'DPMSolverMultistepScheduler', choices=[
        'DPMSolverMultistepScheduler', 'DDPMScheduler'], help=
