def parse_args():
    ...
    parser.add_argument('--use_peft', action='store_true', help=
        'Whether to use peft to support lora')
    ...
    parser.add_argument('--lora_alpha', type=int, default=32, help=
        'Lora alpha, only used if lora is True')
    parser.add_argument('--lora_dropout', type=float, default=0.0, help=
        'Lora dropout, only used if use_lora is True')
    ...
    parser.add_argument('--lora_text_encoder_r', type=int, default=4, help=
        'Lora rank for text encoder, only used if `use_lora` and `train_text_encoder` are True'
        )
    parser.add_argument('--lora_text_encoder_alpha', type=int, default=32,
        help=
        'Lora alpha for text encoder, only used if `use_lora` and `train_text_encoder` are True'
        )
    parser.add_argument('--lora_text_encoder_dropout', type=float, default=
        0.0, help=
        'Lora dropout for text encoder, only used if `use_lora` and `train_text_encoder` are True'
        )
    parser.add_argument('--lora_text_encoder_bias', type=str, default=
        'none', help=
