def parse_args():
    parser = argparse.ArgumentParser(description=
        'Example of distillation for quantization on Textual Inversion.')
    ...
    parser.add_argument('--max_grad_norm', default=1.0, type=float, help=
        'Max gradient norm.')
    parser.add_argument('--do_quantization', action='store_true', help=
        'Whether or not to do quantization.')
    parser.add_argument('--do_distillation', action='store_true', help=
        'Whether or not to do distillation.')
    parser.add_argument('--verify_loading', action='store_true', help=
        'Whether or not to verify the loading of the quantized model.')
