def __init__(self, vae: AutoencoderKL, text_encoder: CLIPTextModel,
    ...
    stages=['clip', 'unet', 'vae'], image_height: int=768, image_width: int
    =768, max_batch_size: int=16, onnx_opset: int=17, onnx_dir: str='onnx',
    engine_dir: str='engine', build_preview_features: bool=True,
    force_engine_rebuild: bool=False, timing_cache: str='timing_cache'):
