@torch.no_grad()
def text2img(self, prompt: Union[str, List[str]], height: int=512, width:
    ...
    int=1):
    return StableDiffusionPipeline(**self.components)(prompt=prompt, height
        =height, width=width, num_inference_steps=num_inference_steps,
