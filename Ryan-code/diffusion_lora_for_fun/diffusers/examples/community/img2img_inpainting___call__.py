...
def __call__(self, prompt: Union[str, List[str]], image: Union[torch.Tensor,
    PIL.Image.Image], inner_image: Union[torch.Tensor, PIL.Image.Image],
    mask_image: Union[torch.Tensor, PIL.Image.Image], height: int=512,
    ...
    masked_image = masked_image.to(device=self.device, dtype=
