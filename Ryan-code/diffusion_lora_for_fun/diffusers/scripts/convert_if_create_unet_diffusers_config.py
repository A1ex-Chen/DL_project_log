def create_unet_diffusers_config(original_unet_config, class_embed_type=None):
    ...
    config = {'sample_size': original_unet_config['image_size'],
        'in_channels': original_unet_config['in_channels'],
        'down_block_types': tuple(down_block_types), 'block_out_channels':
        tuple(block_out_channels), 'layers_per_block': original_unet_config
        ['num_res_blocks'], 'cross_attention_dim': original_unet_config[
        'encoder_channels'], 'attention_head_dim': head_dim,
        ...
        'addition_embed_type': 'text', 'act_fn': 'gelu'}
