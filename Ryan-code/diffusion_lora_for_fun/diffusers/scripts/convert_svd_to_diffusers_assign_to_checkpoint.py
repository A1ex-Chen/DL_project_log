def assign_to_checkpoint(paths, checkpoint, old_checkpoint,
    attention_paths_to_split=None, additional_replacements=None, config=
    None, mid_block_suffix=''):
    """
    ...
    for path in paths:
        ...
        if (attention_paths_to_split is not None and new_path in
            ...
            continue
        new_path = new_path.replace('middle_block.0',
            f'mid_block.resnets.0{mid_block_suffix}')
        new_path = new_path.replace('middle_block.1', 'mid_block.attentions.0')
        new_path = new_path.replace('middle_block.2',
            f'mid_block.resnets.1{mid_block_suffix}')
        ...
        if new_path == 'mid_block.resnets.0.spatial_res_block.norm1.weight':
            print('yeyy')
        is_attn_weight = ('proj_attn.weight' in new_path or 'attentions' in
            new_path and 'to_' in new_path)
