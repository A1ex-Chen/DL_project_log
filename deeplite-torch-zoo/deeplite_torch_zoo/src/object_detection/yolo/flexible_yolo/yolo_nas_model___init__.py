def __init__(self, nc=80, arch_name='yolo_nas_l_arch_params', backbone_cfg=
    None, neck_cfg=None, anchors=None, custom_head=None, in_channels=3,
    neck_depth_factor=None, neck_width_factor=None):
    ...
    self.backbone = factory.get(factory.insert_module_param(backbone_cfg,
        'in_channels', in_channels))
    ch_in = self.backbone.out_channels
    self.necks = nn.ModuleList()
    neck = factory.get(factory.insert_module_param(neck_cfg, 'in_channels',
        ch_in))
