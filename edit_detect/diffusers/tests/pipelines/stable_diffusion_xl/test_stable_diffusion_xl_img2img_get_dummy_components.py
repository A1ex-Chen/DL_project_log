def get_dummy_components(self):
    ...
    unet = UNet2DConditionModel(block_out_channels=(32, 64),
        ...
        projection_class_embeddings_input_dim=72, cross_attention_dim=32)
    ...
    components = {'unet': unet, 'scheduler': scheduler, 'vae': vae,
        'tokenizer': None, 'text_encoder': None, 'text_encoder_2':
        text_encoder_2, 'tokenizer_2': tokenizer_2,
        'requires_aesthetics_score': True, 'image_encoder': None,
