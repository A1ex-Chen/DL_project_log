...
def __call__(self, prompt: Union[str, List[str]]=None, image: Union[PIL.
    ...
    torch.Tensor], List[np.ndarray]]=None, strength: float=0.7,
    num_inference_steps: int=80, timesteps: List[int]=None, guidance_scale:
    float=10.0, negative_prompt: Optional[Union[str, List[str]]]=None,
