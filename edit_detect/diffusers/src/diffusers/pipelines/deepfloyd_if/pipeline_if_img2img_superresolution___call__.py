...
def __call__(self, image: Union[PIL.Image.Image, np.ndarray, torch.Tensor],
    ...
    PIL.Image.Image], List[torch.Tensor], List[np.ndarray]]=None, strength:
    float=0.8, prompt: Union[str, List[str]]=None, num_inference_steps: int
    =50, timesteps: List[int]=None, guidance_scale: float=4.0,
    ...
    Optional[Dict[str, Any]]=None, noise_level: int=250, clean_caption:
    bool=True):
    """
    ...
    self.check_inputs(prompt, image, original_image, batch_size,
