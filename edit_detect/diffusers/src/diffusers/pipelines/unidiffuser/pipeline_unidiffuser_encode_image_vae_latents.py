def encode_image_vae_latents(self, image, batch_size, num_prompts_per_image,
    ...
    if isinstance(generator, list):
        image_latents = [(self.vae.encode(image[i:i + 1]).latent_dist.
            sample(generator=generator[i]) * self.vae.config.scaling_factor
