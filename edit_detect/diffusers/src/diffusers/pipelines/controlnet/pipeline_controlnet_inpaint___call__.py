...
def __call__(self, prompt: Union[str, List[str]]=None, image:
    ...
    strength: float=1.0, num_inference_steps: int=50, guidance_scale: float
    ...
    self.check_inputs(prompt, control_image, mask_image, height, width,
        callback_steps, output_type, negative_prompt, prompt_embeds,
