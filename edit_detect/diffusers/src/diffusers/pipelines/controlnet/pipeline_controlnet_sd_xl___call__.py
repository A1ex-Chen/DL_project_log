...
def __call__(self, prompt: Union[str, List[str]]=None, prompt_2: Optional[
    ...
    float, List[float]]=1.0, guess_mode: bool=False, control_guidance_start:
    ...
    self.check_inputs(prompt, prompt_2, image, callback_steps,
        ...
        negative_prompt_embeds, pooled_prompt_embeds, ip_adapter_image,
        ip_adapter_image_embeds, negative_pooled_prompt_embeds,
