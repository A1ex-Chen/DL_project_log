def check_inputs(self, prompt, image, mask_image, height, width,
    callback_steps, output_type, negative_prompt=None, prompt_embeds=None,
    negative_prompt_embeds=None, ip_adapter_image=None,
    ...
    if (height is not None and height % 8 != 0 or width is not None and 
        width % 8 != 0):
        raise ValueError(
