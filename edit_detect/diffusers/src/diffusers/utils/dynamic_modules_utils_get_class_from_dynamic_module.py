...
def get_class_from_dynamic_module(pretrained_model_name_or_path: Union[str,
    ...
    =False, resume_download: Optional[bool]=None, proxies: Optional[Dict[
    str, str]]=None, token: Optional[Union[bool, str]]=None, revision:
    ...
    final_module = get_cached_module_file(pretrained_model_name_or_path,
        ...
        resume_download=resume_download, proxies=proxies, token=token,
