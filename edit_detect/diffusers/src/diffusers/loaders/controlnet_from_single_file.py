...
def from_single_file(cls, pretrained_model_link_or_path, **kwargs):
    ...
    original_config, checkpoint = fetch_ldm_config_and_checkpoint(
        ...
        class_name=class_name, original_config_file=original_config_file,
        resume_download=resume_download, force_download=force_download,
        proxies=proxies, token=token, revision=revision, local_files_only=
        local_files_only, cache_dir=cache_dir)
    upcast_attention = kwargs.pop('upcast_attention', False)
    image_size = kwargs.pop('image_size', None)
    component = create_diffusers_controlnet_model_from_ldm(class_name,
        original_config, checkpoint, upcast_attention=upcast_attention,
        image_size=image_size, torch_dtype=torch_dtype)
