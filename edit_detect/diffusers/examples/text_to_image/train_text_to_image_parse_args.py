def parse_args():
    ...
    parser.add_argument('--dream_training', action='store_true', help=(
        'Use the DREAM training method, which makes training more efficient and accurate at the '
        ,
        'expense of doing an extra forward pass. See: https://arxiv.org/abs/2312.00210'
        ))
    parser.add_argument('--dream_detail_preservation', type=float, default=
        1.0, help=
        'Dream detail preservation factor p (should be greater than 0; default=1.0, as suggested in the paper)'
        )
