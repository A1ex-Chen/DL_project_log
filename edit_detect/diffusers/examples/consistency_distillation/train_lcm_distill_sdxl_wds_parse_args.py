def parse_args():
    ...
    parser.add_argument('--unet_time_cond_proj_dim', type=int, default=256,
        help=
        'The dimension of the guidance scale embedding in the U-Net, which will be used if the teacher U-Net does not have `time_cond_proj_dim` set.'
        )
    ...
    parser.add_argument('--ema_decay', type=float, default=0.95, required=
        False, help=
        'The exponential moving average (EMA) rate or decay factor.')
