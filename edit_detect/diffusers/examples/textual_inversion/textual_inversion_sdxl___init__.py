def __init__(self, data_root, tokenizer_1, tokenizer_2, learnable_property=
    'object', size=512, repeats=100, interpolation='bicubic', flip_p=0.5,
    set='train', placeholder_token='*', center_crop=False):
