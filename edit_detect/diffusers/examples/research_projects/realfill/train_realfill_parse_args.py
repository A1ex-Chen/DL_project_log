def parse_args(input_args=None):
    ...
    parser.add_argument('--train_data_dir', type=str, default=None,
        required=True, help='A folder containing the training data of images.')
    parser.add_argument('--num_validation_images', type=int, default=4,
        help=
        'Number of images that should be generated during validation with `validation_conditioning`.'
        )
    parser.add_argument('--validation_steps', type=int, default=100, help=
        'Run realfill validation every X steps. RealFill validation consists of running the conditioning `args.validation_conditioning` multiple times: `args.num_validation_images`.'
        )
    parser.add_argument('--output_dir', type=str, default='realfill-model',
        help=
    ...
    parser.add_argument('--unet_learning_rate', type=float, default=0.0002,
        help='Learning rate to use for unet.')
    parser.add_argument('--text_encoder_learning_rate', type=float, default
        =4e-05, help='Learning rate to use for text encoder.')
    ...
    parser.add_argument('--wandb_key', type=str, default=None, help=
    ...
    parser.add_argument('--lora_rank', type=int, default=16, help=
        'The dimension of the LoRA update matrices.')
    parser.add_argument('--lora_alpha', type=int, default=27, help=
        'The alpha constant of the LoRA update matrices.')
    parser.add_argument('--lora_dropout', type=float, default=0.0, help=
        'The dropout rate of the LoRA update matrices.')
    parser.add_argument('--lora_bias', type=str, default='none', help=
        "The bias type of the Lora update matrices. Must be 'none', 'all' or 'lora_only'."
        )
