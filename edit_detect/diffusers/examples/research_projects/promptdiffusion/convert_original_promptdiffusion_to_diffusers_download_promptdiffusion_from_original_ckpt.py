def download_promptdiffusion_from_original_ckpt(checkpoint_path: str,
    ...
    controlnet = convert_promptdiffusion_checkpoint(checkpoint,
        original_config, checkpoint_path, image_size, upcast_attention,
        extract_ema, use_linear_projection=use_linear_projection,
