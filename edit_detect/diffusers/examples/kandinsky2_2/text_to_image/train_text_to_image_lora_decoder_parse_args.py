def parse_args():
    parser = argparse.ArgumentParser(description=
        'Simple example of finetuning Kandinsky 2.2 with LoRA.')
    parser.add_argument('--pretrained_decoder_model_name_or_path', type=str,
        default='kandinsky-community/kandinsky-2-2-decoder', required=False,
        help=
        'Path to pretrained model or model identifier from huggingface.co/models.'
        )
    parser.add_argument('--pretrained_prior_model_name_or_path', type=str,
        default='kandinsky-community/kandinsky-2-2-prior', required=False,
        help=
        'Path to pretrained model or model identifier from huggingface.co/models.'
        )
    ...
    parser.add_argument('--output_dir', type=str, default=
        'kandi_2_2-model-finetuned-lora', help=
