def check_inputs(self, prompt, height, width, callback_steps,
    ...
    callback_on_step_end_tensor_inputs=None, latent_interpolation_method=None):
    ...
    if latent_interpolation_method is not None:
        if latent_interpolation_method not in ['lerp', 'slerp'
            ] and not isinstance(latent_interpolation_method, FunctionType):
            raise ValueError(
