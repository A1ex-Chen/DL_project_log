def prompt_wrap(self, img_embeds, input_ids, target_ids, attention_mask,
    vision_mask, use_system, vision_type, task_type):
    """
    ...
    p_before = make_prompt_start(use_system=use_system, vision_type=
    ...
    attention_mask = torch.cat([atts_bos, p_before_attn_mask, vision_mask,
