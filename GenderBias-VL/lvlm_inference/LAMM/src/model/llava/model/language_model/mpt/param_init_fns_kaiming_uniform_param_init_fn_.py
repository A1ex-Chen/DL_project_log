def kaiming_uniform_param_init_fn_(module: nn.Module, n_layers: int,
    ...
    init_gain: float=0, fan_mode: str='fan_in', init_nonlinearity: str=
    'leaky_relu', verbose: int=0, **kwargs):
    del kwargs
    if verbose > 1:
        warnings.warn(
    ...
    kaiming_uniform_ = partial(nn.init.kaiming_uniform_, a=init_gain, mode=
        fan_mode, nonlinearity=init_nonlinearity)
