            ...
            if self.check_all_rank_done():
                ...
                for i in range(self.dist_args['world_size']):
                    with open(os.path.join(self.save_base_dir, \
                        'tmp', f'{self.dataset_name}_{i}.json'), 'r', encoding='utf8') as f:
...
def load_config():
    ...
    #### modify recipe_cfg eval_cfg.inferencer_cfg.batch_size
    if args.batch_size is not None:
        recipe_cfg['eval_cfg']['inferencer_cfg']['batch_size'] = args.batch_size
