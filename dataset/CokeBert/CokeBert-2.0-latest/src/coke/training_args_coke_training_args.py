def coke_training_args():
    ...
    parser.add_argument('--backbone', default='bert', type=str, help=
...
"""
    ...
    parser.add_argument('--neighbor_hop', type=int, default=2, help=
        'How far will the contexualized knowledge be from the entity mention on the KG'
        )
