@add_start_docstrings_to_model_forward(SQUEEZEBERT_INPUTS_DOCSTRING.format(
    '(batch_size, sequence_length)'))
@add_code_sample_docstrings(tokenizer_class=_TOKENIZER_FOR_DOC, checkpoint=
    'squeezebert/squeezebert-mnli-headless', output_type=
...
def forward(self, input_ids=None, attention_mask=None, token_type_ids=None,
    ...
    None, end_positions=None, output_attentions=None, output_hidden_states=
