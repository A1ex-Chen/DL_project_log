def on_batch_end(self, epoch: int, num_batches_in_epoch: int, n_batch: int,
    ...
    self.summary_writer.add_scalar('loss/anchor_objectness_loss',
        anchor_objectness_loss, global_batch)
    self.summary_writer.add_scalar('loss/anchor_transformer_loss',
        anchor_transformer_loss, global_batch)
    self.summary_writer.add_scalar('loss/proposal_class_loss',
        proposal_class_loss, global_batch)
    self.summary_writer.add_scalar('loss/proposal_transformer_loss',
        proposal_transformer_loss, global_batch)
