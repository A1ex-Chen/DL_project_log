...
def load(path_to_checkpoint: str, device: torch.device) ->'Checkpoint':
    ...
    algorithm: Algorithm = algorithm_class(num_classes, pretrained=
        algorithm_params['pretrained'], num_frozen_levels=algorithm_params[
        'num_frozen_levels'], eval_center_crop_ratio=algorithm_params[
