...
def __call__(self, prompt: Union[str, List[str]]=None, image: Union[torch.
    ...
    strength: float=0.8, height: Optional[int]=None, width: Optional[int]=
    ...
    self.check_inputs(prompt, image, mask_image,
        ...
        negative_prompt, prompt_embeds, negative_prompt_embeds, strength)
    ...
    controlnet_conditioning_image = prepare_controlnet_conditioning_image(
        controlnet_conditioning_image, width, height, batch_size *
        num_images_per_prompt, num_images_per_prompt, device, self.
        controlnet.dtype)
    ...
    with self.progress_bar(total=num_inference_steps) as progress_bar:
        for i, t in enumerate(timesteps):
            ...
            down_block_res_samples, mid_block_res_sample = self.controlnet(
                ...
                controlnet_conditioning_image, return_dict=False)
            down_block_res_samples = [(down_block_res_sample *
                controlnet_conditioning_scale) for down_block_res_sample in
