def parse_args(input_args=None):
    ...
    parser.add_argument('--eval_shards_path_or_url', type=str, default=None,
        help=
    ...
    parser.add_argument('--control_type', type=str, default='canny', help=
        'The type of controlnet conditioning image to use. One of `canny`, `depth` Defaults to `canny`.'
        )
    parser.add_argument('--transformer_layers_per_block', type=str, default
        =None, help=
        'The number of layers per block in the transformer. If None, defaults to `args.transformer_layers`.'
        )
    parser.add_argument('--old_style_controlnet', action='store_true',
        default=False, help=
