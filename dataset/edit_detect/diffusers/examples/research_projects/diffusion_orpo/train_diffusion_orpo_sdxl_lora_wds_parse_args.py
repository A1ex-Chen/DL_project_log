def parse_args(input_args=None):
    ...
    parser.add_argument('--dataset_path', type=str, default=
        'pipe:aws s3 cp s3://diffusion-preference-opt/{00000..00644}.tar -')
    parser.add_argument('--num_train_examples', type=int, default=1001352)
    ...
    parser.add_argument('--run_validation', default=False, action=
        'store_true', help=
    ...
    parser.add_argument('--global_batch_size', type=int, default=64, help=
        'Total batch size.')
    parser.add_argument('--per_gpu_batch_size', type=int, default=8, help=
        'Number of samples in a batch for a single GPU.')
    ...
    parser.add_argument('--beta_orpo', type=float, default=0.1, help=
        'ORPO contribution factor.')
    ...
    parser.add_argument('--tracker_name', type=str, default=
        'diffusion-orpo-lora-sdxl', help=
        'The name of the tracker to report results to.')
