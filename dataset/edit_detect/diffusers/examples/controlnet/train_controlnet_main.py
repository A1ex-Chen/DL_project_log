def main(args):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                ...
                down_block_res_samples, mid_block_res_sample = controlnet(
                    ...
                    encoder_hidden_states, controlnet_cond=controlnet_image,
                    return_dict=False)
                ...
                if accelerator.is_main_process:
                    ...
                    if (args.validation_prompt is not None and global_step %
                        ...
                        image_logs = log_validation(vae, text_encoder,
                            tokenizer, unet, controlnet, args, accelerator,
    ...
    if accelerator.is_main_process:
        ...
        if args.validation_prompt is not None:
            image_logs = log_validation(vae=vae, text_encoder=text_encoder,
                tokenizer=tokenizer, unet=unet, controlnet=None, args=args,
                accelerator=accelerator, weight_dtype=weight_dtype, step=
