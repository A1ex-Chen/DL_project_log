def _get_dummy_components(self):
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        'hf-internal-testing/tiny-random-t5')
    torch.manual_seed(0)
    unet = UNet2DConditionModel(sample_size=32, layers_per_block=1,
        ...
        'SimpleCrossAttnUpBlock2D', 'ResnetUpsampleBlock2D'], in_channels=3,
    ...
    return {'text_encoder': text_encoder, 'tokenizer': tokenizer, 'unet':
        unet, 'scheduler': scheduler, 'watermarker': watermarker,
