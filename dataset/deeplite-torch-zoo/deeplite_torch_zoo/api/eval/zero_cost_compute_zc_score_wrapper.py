def compute_zc_score_wrapper(model, dataloader=None, model_output_generator
    =None, loss_fn=None, inplace=False, do_gaussian_init=False, eval_mode=
    False, fuse=False, **kwargs):
