def main():
    ...
    if args.precision == 'fp16':
        logging.warning(
            'It is recommended to use fp32 mixed-precision instead of FP16 and AMP in this model. They will cause NaN loss and NaN gradients. FP16 and AMP support needs further verification and tuning, especially for train.'
            )
    if args.horovod:
        logging.info(
    ...
    if args.wandb and is_master(args):
        ...
        wandb.init(entity='clap', project='clap', notes=args.wandb_notes,
            name=args.wandb_notes, tags=[], config=vars(args))
        if args.debug:
