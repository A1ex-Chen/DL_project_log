def __init__(self, vae: AutoencoderKL, text_encoder: CLIPTextModel,
    ...
    LMSDiscreteScheduler], feature_extractor: CLIPImageProcessor,
    safety_checker: StableDiffusionSafetyChecker, inverse_scheduler:
    DDIMInverseScheduler, caption_generator: BlipForConditionalGeneration,
    caption_processor: BlipProcessor, requires_safety_checker: bool=True):
    super().__init__()
    ...
    self.register_modules(vae=vae, text_encoder=text_encoder, tokenizer=
        ...
        caption_processor=caption_processor, caption_generator=
        caption_generator, inverse_scheduler=inverse_scheduler)
