def __init__(self, args, is_train, split, preprocess_dir, virtual_kitti_dir
    ='', vfm_data_paths='', merge_classes=False, scale=20, full_scale=4096,
    image_normalizer=None, noisy_rot=0.0, flip_y=0.0, rot_z=0.0, transl=
    False, downsample=(-1,), crop_size=tuple(), bottom_crop=False,
    rand_crop=tuple(), fliplr=0.0, color_jitter=None, random_weather=tuple()):
