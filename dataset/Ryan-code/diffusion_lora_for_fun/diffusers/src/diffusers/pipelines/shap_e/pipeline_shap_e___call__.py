...
def __call__(self, prompt: str, num_images_per_prompt: int=1,
    ...
    guidance_scale: float=4.0, frame_size: int=64, output_type: Optional[
    ...
    latents = self.prepare_latents((batch_size, num_embeddings *
        embedding_dim), prompt_embeds.dtype, device, generator, latents,
        self.scheduler)
