...
def __call__(self, prompt: Union[str, List[str]]=None, height: Optional[int
    ...
    timesteps: List[int]=None, guidance_scale: float=7.5, negative_prompt:
    ...
    Optional[torch.Tensor]=None, image_embeds: Optional[torch.Tensor]=None,
    output_type: Optional[str]='pil', return_dict: bool=True,
    cross_attention_kwargs: Optional[Dict[str, Any]]=None, guidance_rescale:
    float=0.0, clip_skip: Optional[int]=None, callback_on_step_end:
    ...
    if image_embeds is not None:
        image_embeds = torch.stack([image_embeds] * num_images_per_prompt,
            dim=0).to(device=device, dtype=prompt_embeds.dtype)
    ...
    added_cond_kwargs = {'image_embeds': image_embeds
        } if image_embeds is not None else {}
    timestep_cond = None
