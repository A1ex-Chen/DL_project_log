def inpaint(self, image: Union[torch.Tensor, PIL.Image.Image], mask_image:
    Union[torch.Tensor, PIL.Image.Image], prompt: Union[str, List[str]],
    ...
    float]=7.5, num_images_per_prompt: Optional[int]=1, add_predicted_noise:
    Optional[bool]=False, eta: Optional[float]=0.0, generator: Optional[
    ...
    Tensor]=None, max_embeddings_multiples: Optional[int]=3, output_type:
    Optional[str]='pil', return_dict: bool=True, callback: Optional[
    Callable[[int, int, torch.Tensor], None]]=None, is_cancelled_callback:
    Optional[Callable[[], bool]]=None, callback_steps: int=1,
    ...
    return self.__call__(prompt=prompt, negative_prompt=negative_prompt,
        ...
        strength, num_images_per_prompt=num_images_per_prompt,
        add_predicted_noise=add_predicted_noise, eta=eta, generator=
