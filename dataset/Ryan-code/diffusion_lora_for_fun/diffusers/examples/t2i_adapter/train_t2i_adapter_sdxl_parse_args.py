def parse_args(input_args=None):
    ...
    parser.add_argument('--adapter_model_name_or_path', type=str, default=
        None, help=
        'Path to pretrained adapter model or model identifier from huggingface.co/models. If not specified adapter weights are initialized w.r.t the configurations of SDXL.'
        )
    ...
    parser.add_argument('--detection_resolution', type=int, default=None,
        help=
        'The resolution for input images, all the images in the train/validation dataset will be resized to this resolution'
        )
    ...
    parser.add_argument('--conditioning_image_column', type=str, default=
        ...
        'The column of the dataset containing the adapter conditioning image.')
